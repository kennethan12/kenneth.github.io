...
There are two Code of Ethics that are extremely important to keep in mind when designing anything: the [ACM Code of Ethics and Professional Conduct](https://www.acm.org/code-of-ethics), created by the Association for Computing Machinery (ACM), and the [Signal Code](ethics-sol-2018-TheSignalCode-excerpt.pdf), provided by the Harvard Humanitarian Initiative. Both codes are based on the understanding that the public good is always the primary consideration.
